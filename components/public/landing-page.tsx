...
import { PublicLandingHeroFeatures, PublicPageHero } from "@/components/public/public-page-hero";
...
export function LandingPage() {
  return (
    <div className="w-full">
      ...
      <PublicLandingHeroFeatures>
        <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-6 rounded-2xl border border-brand-medium/15 bg-[#f7f4ef] px-5 py-6 shadow-sm sm:grid-cols-2 sm:px-8 sm:py-7 lg:grid-cols-4 lg:gap-8 lg:px-10">
      ...
      <section id="cours" className={`bg-[#faf7f2] px-6 pb-13 pt-12 text-brand-dark sm:px-8 sm:pt-16 lg:px-10 ${sectionScrollTop}`}>
